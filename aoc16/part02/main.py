...
def calc_num_energized(starting_beam: Beam, contraption: Map) -> int:
    queue = deque([starting_beam])
    ...
    return len({beam.position for beam in energized})
...
def main() -> None:
    ...
    for x in range(contraption.width):
        num_energized = calc_num_energized(Beam(Vec2(x, 0), direction), contraption)
    ...
    for x in range(contraption.width):
        num_energized = calc_num_energized(Beam(Vec2(x, contraption.height - 1), direction), contraption)
        if num_energized > max_num_energized:
            max_num_energized = num_energized
    ...
    for y in range(contraption.height):
        num_energized = calc_num_energized(Beam(Vec2(0, y), direction), contraption)
        if num_energized > max_num_energized:
            max_num_energized = num_energized
    ...
    for y in range(contraption.height):
        num_energized = calc_num_energized(Beam(Vec2(contraption.width - 1, y), direction), contraption)
        if num_energized > max_num_energized:
            max_num_energized = num_energized
